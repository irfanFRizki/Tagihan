...
function action_dashboard()
    ...
    data.pdam.tunggakan       = uci:get("tagihan","pdam","tunggakan")       or "0"
    data.pdam.tunggakan_str   = uci:get("tagihan","pdam","tunggakan_str")   or ""
    data.pdam.total_bayar     = uci:get("tagihan","pdam","total_bayar")     or "0"
    data.pdam.period_tunggakan= uci:get("tagihan","pdam","period_tunggakan")or ""
