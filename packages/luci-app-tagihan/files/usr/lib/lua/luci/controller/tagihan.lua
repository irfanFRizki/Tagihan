...
-- LuCI Controller untuk Tagihan Bot
module("luci.controller.tagihan", package.seeall)

function index()
    if not nixio.fs.access("/etc/config/tagihan") then return end
    local page
    ...
    -- API endpoint untuk refresh AJAX
...
function action_refresh()
    ...
    -- Jalankan checker di background
